...
namespace JTranEdit
{
	...
	public static class TextEditCommands
	{
		...
		/// </summary>
		public static readonly RoutedCommand FoldsCollapseAll = new RoutedCommand("Collapse", typeof(TextEditor)
		...
		/// </summary>
		public static readonly RoutedCommand FoldsExpandAll = new RoutedCommand("Expand", typeof(TextEditor)
		  ////, new InputGestureCollection { new KeyGesture(Key.D, ModifierKeys.Control) }
		  );
	}
}
